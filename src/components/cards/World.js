...
export default class World extends Component {
  ...
  render() {
    ...
    return (
      <div id={this.id}
      className={"sensuba-card sensuba-world " + this.props.classColor + " " + rarityclass(src.rarity, src.idEdition) + " " + (holographic ? "sensuba-card-holographic " : " ") + this.props.className}
      onMouseMove={e => {
      		if (holographic) {
