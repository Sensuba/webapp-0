...
export default class Card extends Component {
  ...
  render() {
    ...
    var descHTML = desc => {
      ...
      desc = desc.replace(/initiative|fury|rush|exaltation|liberate|lethal|conceal(ed)?|encore|frenzy:?|last will(s|:)?|silence|shield|flying|freeze|frozen|overload|trap:/gi, x => `<b>${x}</b>`);
