...
const blocks = [
	...
	{ type: "load", name: "Load Pilot", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "card", name: "mech"}, {inout: "in", type: "card", name: "pilot"}, {inout: "out", type: "exe", name: " "} ], event:[ {inout: "in", type: "data", name: "data"}, {inout: "in", type: "card", name: "mech"}, {inout: "in", type: "card", name: "pilot"} ], tooltip: "Embarque un pilote dans un mecha", color: "#73BEC8" },
	{ type: "activate", name: "Activate", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "card", name: "mech"}, {inout: "out", type: "exe", name: " "} ], event:[ {inout: "in", type: "data", name: "data"}, {inout: "in", type: "card", name: "mech"} ], tooltip: "Active un mecha", color: "#73BEC8" },
