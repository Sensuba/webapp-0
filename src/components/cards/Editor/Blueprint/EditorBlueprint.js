...
const blocks = [
	...
	{ type: "move", name: "Move", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "card", name: "card"}, {inout: "in", type: "location", name: "location"}, {inout: "out", type: "exe", name: " "} ], event: [ {inout: "in", type: "data", name: "data"}, {inout: "out", type: "card", name: "card"}, {inout: "out", type: "location", name: "location"} ], tooltip: "Move a card to a given location", color: "#73BEC8" },
	{ type: "damage", name: "Damage", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "card", name: "entity"}, {inout: "in", type: "card", name: "source"}, {inout: "in", type: "int", name: "damage"}, {inout: "out", type: "exe", name: " "} ], event: [ {inout: "in", type: "data", name: "data"}, {inout: "out", type: "card", name: "entity"}, {inout: "out", type: "int", name: "damage"} ], tooltip: "Deal a certain amount of damage to an entity", color: "#73BEC8" },
	{ type: "heal", name: "Heal", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "card", name: "entity"}, {inout: "in", type: "card", name: "source"}, {inout: "in", type: "int", name: "heal"}, {inout: "out", type: "exe", name: " "} ], event: [ {inout: "in", type: "data", name: "data"}, {inout: "out", type: "card", name: "card"}, {inout: "out", type: "int", name: "heal"} ], tooltip: "Restore a certain amount of health to a character", color: "#73BEC8" },
	...
	{ type: "set", name: "Set", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "card", name: "card"}, {inout: "in", type: "int", name: "cost"}, {inout: "in", type: "int", name: "atk"}, {inout: "in", type: "int", name: "hp"}, {inout: "in", type: "int", name: "range"}, {inout: "out", type: "exe", name: " "} ], event: [ {inout: "in", type: "data", name: "data"}, {inout: "out", type: "card", name: "card"}, {inout: "out", type: "int", name: "atk"}, {inout: "out", type: "int", name: "hp"}, {inout: "out", type: "int", name: "range"} ], tooltip: "Set a card statistics to a specific amount", color: "#73BEC8" },
	...
	{ type: "destroy", name: "Destroy", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "card", name: "card"}, {inout: "out", type: "exe", name: " "} ], event: [ {inout: "in", type: "data", name: "data"}, {inout: "out", type: "card", name: "card"} ], tooltip: "Destroy a card", color: "#73BEC8" },
	...
	{ type: "createreceptacle", name: "Create receptacle", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "area", name: "player"}, {inout: "in", type: "int", name: "count"}, {inout: "out", type: "exe", name: " "} ], event: [ {inout: "in", type: "data", name: "data"}, {inout: "out", type: "area", name: "player"} ], tooltip: "Create mana receptacles for a player", color: "#73BEC8" },
