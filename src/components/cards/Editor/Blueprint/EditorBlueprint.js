...
const blocks = [
	...
	{ type: "poison", name: "Poison", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "card", name: "character"}, {inout: "in", type: "int", name: "poison"}, {inout: "out", type: "exe", name: " "} ], tooltip: "Deal poison to a character", color: "#73BEC8" },
