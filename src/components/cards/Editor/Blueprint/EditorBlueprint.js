...
const blocks = [
	...
	{ type: "filtercard", name: "Filter card", model: [ {inout: "in", type: "card", name: "card"}, {inout: "out", type: "cardfilter", name: "same"}, {inout: "out", type: "cardfilter", name: "different"}, {inout: "out", type: "modelfilter", name: "same model"} ], tooltip: "Get a filter focused on a single card", color: "#89BC62" },
