...
const blocks = [
	...
	{ type: "forstart", name: "For each starting card", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "event", name: "event"}, {inout: "in", type: "period", name: "period"}, {inout: "in", type: "bool", name: "condition"}, {inout: "out", type: "exe", name: "completed"}, {inout: "out", type: "exe", name: "for each"}, {inout: "out", type: "model", name: "model"} ], tooltip: "Appelle un script pour chaque carte dans le deck de départ", color: "#C0C0C0" },
	{ type: "flcards", name: "First/last cards", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "area", name: "player"}, {inout: "in", type: "modelfilter", name: "targets"}, {inout: "out", type: "exe", name: "completed"}, {inout: "out", type: "exe", name: "for each"}, {inout: "out", type: "model", name: "card"} ], tooltip: "Appelle un script pour les premières ou dernières cartes d'un emplacement", color: "#C0C0C0" },
