...
const blocks = [
	...
	{ type: "enrage", name: "Enrage", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "card", name: "character"}, {inout: "in", type: "mutation", name: "mutation"}, {inout: "out", type: "exe", name: " "}, {inout: "in", type: "card", name: "target"} ], tooltip: "Enrage un personnage", color: "#73BEC8" },
