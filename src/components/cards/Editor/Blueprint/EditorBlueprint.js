...
const blocks = [
	...
	{ type: "play", name: "Play", model: [ {inout: "out", type: "effect", name: " "}, {inout: "in", type: "tilefilter", name: "targetable"}, {inout: "out", type: "exe", name: " "}, {inout: "out", type: "card", name: "target"}, {inout: "out", type: "location", name: "target"} ], event: [ {inout: "out", type: "event", name: "event"}, {inout: "out", type: "card", name: "card"}, {inout: "out", type: "card", name: "target"}, {inout: "out", type: "location", name: "target"}, {inout: "out", type: "bool", name: "has target"} ], tooltip: "Call a script whenever the card is played, with an optional target", color: "#871212" },
	...
	{ type: "listener", name: "Listener", model: [ {inout: "in", type: "event", name: "event"}, {inout: "in", type: "bool", name: "on board"}, {inout: "out", type: "effect", name: " "}, {inout: "out", type: "exe", name: " "} ], tooltip: "Call a script whenever a specific event is handled", color: "#871212" },
	...
	{ type: "draw", name: "Draw", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "int", name: "number"}, {inout: "in", type: "area", name: "player"}, {inout: "in", type: "cardfilter", name: "filter"}, {inout: "out", type: "exe", name: " "}, {inout: "out", type: "card", name: "card"} ], event: [ {inout: "out", type: "event", name: "event"}, {inout: "out", type: "card", name: "card"}, {inout: "out", type: "area", name: "player"} ], tooltip: "Make a player draw cards", color: "#73BEC8" },
	{ type: "summon", name: "Summon", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "card", name: "entity"}, {inout: "in", type: "location", name: "tile"}, {inout: "out", type: "exe", name: " "} ], event: [ {inout: "out", type: "event", name: "event"}, {inout: "out", type: "card", name: "entity"}, {inout: "out", type: "location", name: "tile"} ], tooltip: "Summon an entity on a given tile", color: "#73BEC8" },
	{ type: "attack", name: "Attack", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "card", name: "character"}, {inout: "in", type: "card", name: "target"}, {inout: "out", type: "exe", name: " "} ], event: [ {inout: "out", type: "event", name: "event"}, {inout: "out", type: "card", name: "character"}, {inout: "out", type: "card", name: "target"} ], tooltip: "Force a character to attack a target", color: "#73BEC8" },
	{ type: "move", name: "Move", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "card", name: "card"}, {inout: "in", type: "location", name: "location"}, {inout: "out", type: "exe", name: " "} ], event: [ {inout: "out", type: "event", name: "event"}, {inout: "out", type: "card", name: "card"}, {inout: "out", type: "location", name: "location"} ], tooltip: "Move a card to a given location", color: "#73BEC8" },
	{ type: "damage", name: "Damage", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "card", name: "entity"}, {inout: "in", type: "card", name: "source"}, {inout: "in", type: "int", name: "damage"}, {inout: "out", type: "exe", name: " "} ], event: [ {inout: "out", type: "event", name: "event"}, {inout: "out", type: "card", name: "entity"}, {inout: "out", type: "int", name: "damage"} ], tooltip: "Deal a certain amount of damage to an entity", color: "#73BEC8" },
	{ type: "heal", name: "Heal", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "card", name: "entity"}, {inout: "in", type: "card", name: "source"}, {inout: "in", type: "int", name: "heal"}, {inout: "out", type: "exe", name: " "} ], event: [ {inout: "out", type: "event", name: "event"}, {inout: "out", type: "card", name: "card"}, {inout: "out", type: "int", name: "heal"} ], tooltip: "Restore a certain amount of health to a character", color: "#73BEC8" },
	{ type: "boost", name: "Boost", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "card", name: "character"}, {inout: "in", type: "int", name: "atk"}, {inout: "in", type: "int", name: "hp"}, {inout: "in", type: "int", name: "range"}, {inout: "out", type: "exe", name: " "} ], event: [ {inout: "out", type: "event", name: "event"}, {inout: "out", type: "card", name: "card"}, {inout: "out", type: "int", name: "atk"}, {inout: "out", type: "int", name: "hp"}, {inout: "out", type: "int", name: "range"} ], tooltip: "Increase a character's statistics by a certain amount", color: "#73BEC8" },
	{ type: "set", name: "Set", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "card", name: "card"}, {inout: "in", type: "int", name: "cost"}, {inout: "in", type: "int", name: "atk"}, {inout: "in", type: "int", name: "hp"}, {inout: "in", type: "int", name: "range"}, {inout: "out", type: "exe", name: " "} ], event: [ {inout: "out", type: "event", name: "event"}, {inout: "out", type: "card", name: "card"}, {inout: "out", type: "int", name: "atk"}, {inout: "out", type: "int", name: "hp"}, {inout: "out", type: "int", name: "range"} ], tooltip: "Set a card statistics to a specific amount", color: "#73BEC8" },
	{ type: "silence", name: "Silence", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "card", name: "character"}, {inout: "out", type: "exe", name: " "} ], event: [ {inout: "out", type: "event", name: "event"}, {inout: "out", type: "card", name: "card"} ], tooltip: "Silence a character", color: "#73BEC8" },
	{ type: "destroy", name: "Destroy", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "card", name: "card"}, {inout: "out", type: "exe", name: " "} ], event: [ {inout: "out", type: "event", name: "event"}, {inout: "out", type: "card", name: "card"} ], tooltip: "Destroy a card", color: "#73BEC8" },
	{ type: "transform", name: "Transform", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "card", name: "card"}, {inout: "in", type: "model", name: "model"}, {inout: "out", type: "exe", name: " "} ], event: [ {inout: "out", type: "event", name: "event"}, {inout: "out", type: "card", name: "card"} ], tooltip: "Transform a card into another", color: "#73BEC8" },
	{ type: "addshield", name: "Add shield", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "card", name: "character"}, {inout: "out", type: "exe", name: " "} ], event: [ {inout: "out", type: "event", name: "event"}, {inout: "out", type: "card", name: "character"} ], tooltip: "Give a shield to a character", color: "#73BEC8" },
	{ type: "breakshield", name: "Break shield", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "card", name: "character"}, {inout: "out", type: "exe", name: " "} ], event: [ {inout: "out", type: "event", name: "event"}, {inout: "out", type: "card", name: "character"} ], tooltip: "Break a character's shield", color: "#73BEC8" },
	{ type: "freeze", name: "Freeze", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "card", name: "character"}, {inout: "out", type: "exe", name: " "} ], event: [ {inout: "out", type: "event", name: "event"}, {inout: "out", type: "card", name: "character"} ], tooltip: "Freeze a character", color: "#73BEC8" },
	...
	{ type: "levelup", name: "Level up", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "card", name: "hero"}, {inout: "out", type: "exe", name: " "} ], event: [ {inout: "out", type: "event", name: "event"}, {inout: "out", type: "card", name: "hero"}, {inout: "out", type: "int", name: "level"} ], tooltip: "Level up a hero", color: "#73BEC8" },
	...
	{ type: "generate", name: "Generate", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "model", name: "model"}, {inout: "in", type: "int", name: "count"}, {inout: "in", type: "location", name: "location"}, {inout: "out", type: "exe", name: " "}, {inout: "out", type: "card", name: "card"} ], event: [ {inout: "out", type: "event", name: "event"}, {inout: "out", type: "card", name: "card"}, {inout: "out", type: "location", name: "location"} ], tooltip: "Generate cards on the gameboard", color: "#73BEC8" },
	{ type: "createmana", name: "Refill mana", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "area", name: "player"}, {inout: "in", type: "int", name: "max"}, {inout: "out", type: "exe", name: " "} ], event: [ {inout: "out", type: "event", name: "event"}, {inout: "out", type: "area", name: "player"}, {inout: "out", type: "int", name: "mana"} ], tooltip: "Refill a player's mana", color: "#73BEC8" },
	{ type: "usemana", name: "Use mana", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "area", name: "player"}, {inout: "in", type: "int", name: "mana"}, {inout: "out", type: "exe", name: " "} ], event: [ {inout: "out", type: "event", name: "event"}, {inout: "out", type: "area", name: "player"}, {inout: "out", type: "int", name: "mana"} ], tooltip: "Use a player's mana", color: "#73BEC8" },
	{ type: "createreceptacle", name: "Create receptacle", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "area", name: "player"}, {inout: "in", type: "int", name: "count"}, {inout: "out", type: "exe", name: " "} ], event: [ {inout: "out", type: "event", name: "event"}, {inout: "out", type: "area", name: "player"} ], tooltip: "Create mana receptacles for a player", color: "#73BEC8" },
	{ type: "destroyreceptacle", name: "Destroy receptacle", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "area", name: "player"}, {inout: "in", type: "int", name: "count"}, {inout: "out", type: "exe", name: " "} ], event: [ {inout: "out", type: "event", name: "event"}, {inout: "out", type: "area", name: "player"} ], tooltip: "Destroy a player's mana receptacles", color: "#73BEC8" },
	{ type: "creategem", name: "Create gem", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "area", name: "player"}, {inout: "in", type: "int", name: "count"}, {inout: "out", type: "exe", name: " "} ], event: [ {inout: "out", type: "event", name: "event"}, {inout: "out", type: "area", name: "player"} ], tooltip: "Create gems for a player", color: "#73BEC8" },
	{ type: "destroygem", name: "Destroy gem", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "area", name: "player"}, {inout: "in", type: "int", name: "count"}, {inout: "out", type: "exe", name: " "} ], event: [ {inout: "out", type: "event", name: "event"}, {inout: "out", type: "area", name: "player"} ], tooltip: "Destroy a player's gems", color: "#73BEC8" },
	...
	{ type: "customevent", name: "Custom event", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "string", name: "name"}, {inout: "out", type: "exe", name: " "} ], event: [ {inout: "in", type: "string", name: "name"}, {inout: "out", type: "event", name: "event"} ], tooltip: "Trigger a custom event", color: "#73BEC8" },
	...
	{ type: "conditionmut", name: "Conditional mutation", model: [ {inout: "in", type: "mutation", name: "mutation"}, {inout: "in", type: "bool", name: "condition"}, {inout: "out", type: "mutation", name: "result"} ], tooltip: "Work in progress", color: "#89BC62" },
	    ...
	    <div className={"blueprint-menu " + this.props.className}>
	    	<div id="blueprint-tooltip" data-toggle="tooltip" data-placement="right" data-animation="false" data-trigger="manual">
  			...
  			<div className="blueprint-nav">
  				...
  				{
  					blocks.filter(block => block.name.toLowerCase().includes(this.state.filter)).map(block => <Tray onMouseMove={e => this.updateTooltip(e, block.tooltip)} onMouseLeave={e => this.hideTooltip()} key={block.type} type={block.type} name={block.name} model={block.model} event={block.event} color={block.color}/>)
  				}
  				</div>
  			</div>
