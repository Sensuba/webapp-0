...
const blocks = [
	...
	{ type: "cursedmg", name: "Curse damage", model: [ {inout: "in", type: "area", name: "player"}, {inout: "out", type: "int", name: "damage"} ], tooltip: "Récupère les dégâts de la prochaine malédiction d'un joueur", color: "#89BC62" },
