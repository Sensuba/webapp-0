	    ...
	    <div className={"blueprint-menu " + this.props.className}>
  			<div className="blueprint-nav">
  				...
  				<div className="blueprint-nav-body">
  					...
  					<Tray type="brkcard" name="Break card" model={[ {inout: "in", type: "card", name: "card"}, {inout: "out", type: "model", name: "model"}, {inout: "out", type: "location", name: "location"}, {inout: "out", type: "area", name: "player"}, {inout: "out", type: "filter", name: "type"}, {inout: "out", type: "int", name: "mana"}, {inout: "out", type: "int", name: "atk"}, {inout: "out", type: "int", name: "hp"}, {inout: "out", type: "int", name: "range"}, {inout: "out", type: "int", name: "overload"}, {inout: "out", type: "bool", name: "destroyed"} ]} color="#89BC62"/>
  					...
  					<Tray type="brklocation" name="Break location" model={[ {inout: "in", type: "location", name: "location"}, {inout: "out", type: "area", name: "player"}, {inout: "out", type: "int", name: "count"}, {inout: "out", type: "bool", name: "empty"} ]} color="#89BC62"/>
  					...
  					<Tray type="forcard" name="For each card" model={[ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "locations", name: "tiles"}, {inout: "out", type: "exe", name: "completed"}, {inout: "out", type: "exe", name: "loop"}, {inout: "out", type: "card", name: "card"} ]} color="#C0C0C0"/>
  					<Tray type="aoe" name="Area of effect" model={[ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "locations", name: "tiles"}, {inout: "in", type: "filter", name: "targets"}, {inout: "out", type: "exe", name: "completed"}, {inout: "out", type: "exe", name: "for each"}, {inout: "out", type: "card", name: "card"} ]} color="#C0C0C0"/>
