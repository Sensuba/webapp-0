...
const blocks = [
	...
	{ type: "trial", name: "Trial", model: [ {inout: "in", type: "bool", name: "condition"}, {inout: "in", type: "int", name: "step"}, {inout: "in", type: "int", name: "completion"}, {inout: "out", type: "effect", name: " "}, {inout: "out", type: "exe", name: " "} ], event: [ {inout: "in", type: "data", name: "data"}, {inout: "out", type: "card", name: "secret"} ], tooltip: "Définit une étape d'épreuve", color: "#871212" },
