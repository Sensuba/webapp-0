...
const blocks = [
	...
	{ type: "psuhforward", name: "Push forward", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "card", name: "character"}, {inout: "out", type: "exe", name: " "} ], tooltip: "Push a character forward", color: "#73BEC8" },
