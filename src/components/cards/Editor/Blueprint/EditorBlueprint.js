...
const blocks = [
	...
	{ type: "secret", name: "Secret", model: [ {inout: "out", type: "effect", name: " "}, {inout: "out", type: "exe", name: " "}, {inout: "out", type: "data", name: "data"} ], tooltip: "Call a script when the secret triggers", color: "#871212" },
