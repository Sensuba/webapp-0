	    ...
	    <div className={"blueprint-menu " + this.props.className}>
  			<div className="blueprint-nav">
  				...
  				<div className="blueprint-nav-body">
  					...
  					<Tray type="addmut" name="Add utation" model={[ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "card", name: "card"}, {inout: "in", type: "mutation", name: "mutation"}, {inout: "in", type: "event", name: "end"}, {inout: "out", type: "exe", name: " "} ]} color="#73BEC8"/>
