...
const blocks = [
	...
	{ type: "state", name: "State", model: [ {inout: "in", type: "state", name: " "}, {inout: "in", type: "bool", name: "value"}, {inout: "out", type: "effect", name: " "}, {inout: "out", type: "mutation", name: "mutation"}, {inout: "out", type: "cardfilter", name: "filter"}, {inout: "out", type: "modelfilter", name: "filter"} ], tooltip: "Utilise un état comme effet ou mutation", color: "#ffe521" },
	...
	{ type: "pilotmut", name: "Pilot mutation", model: [ {inout: "in", type: "mutation", name: "mutation"}, {inout: "out", type: "effect", name: " "} ], tooltip: "Applique une mutation à tout mecha piloté par cette figure", color: "#871212" },
	...
	{ type: "attack", name: "Attack", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "card", name: "character"}, {inout: "in", type: "card", name: "target"}, {inout: "in", type: "mutation", name: "mutation"}, {inout: "out", type: "exe", name: " "} ], event: [ {inout: "in", type: "data", name: "data"}, {inout: "out", type: "card", name: "character"}, {inout: "out", type: "card", name: "target"} ], tooltip: "Force un personnage à attaquer une entité", color: "#73BEC8" },
	...
	{ type: "enrage", name: "Enrage", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "card", name: "character"}, {inout: "in", type: "mutation", name: "mutation"}, {inout: "out", type: "exe", name: " "}, {inout: "out", type: "card", name: "target"} ], tooltip: "Enrage un personnage", color: "#73BEC8" },
	...
	{ type: "setstate", name: "Set state", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "card", name: "card"}, {inout: "in", type: "state", name: "state"}, {inout: "in", type: "bool", name: "value"}, {inout: "out", type: "exe", name: " "} ], tooltip: "Modifie l'état d'un personnage", color: "#73BEC8" },
	...
	{ type: "shift", name: "Shift", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "card", name: "card"}, {inout: "in", type: "model", name: "model"}, {inout: "in", type: "event", name: "end"}, {inout: "out", type: "exe", name: " "} ], tooltip: "Transforme temporairement une carte en une autre", color: "#73BEC8" },
	...
	{ type: "addhazards", name: "Add hazards", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "location", name: "tile"}, {inout: "in", type: "hazard", name: "hazard"}, {inout: "out", type: "exe", name: " "} ], event: [ {inout: "in", type: "data", name: "data"}, {inout: "out", type: "location", name: "tile"}, {inout: "out", type: "hazard", name: "hazard"} ], tooltip: "Applique un événement local à une case", color: "#73BEC8" },
	...
	{ type: "charge", name: "Charge", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "card", name: "src"}, {inout: "in", type: "int", name: "charges"}, {inout: "out", type: "exe", name: " "} ], tooltip: "Fait gagner ou perdre une charge à une carte", color: "#73BEC8" },
	{ type: "loadpilot", name: "Load Pilot", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "card", name: "mech"}, {inout: "in", type: "card", name: "pilot"}, {inout: "out", type: "exe", name: " "} ], event:[ {inout: "in", type: "data", name: "data"}, {inout: "out", type: "card", name: "mech"}, {inout: "out", type: "card", name: "pilot"} ], tooltip: "Embarque un pilote dans un mecha", color: "#73BEC8" },
	{ type: "activate", name: "Activate", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "card", name: "mech"}, {inout: "out", type: "exe", name: " "} ], event:[ {inout: "in", type: "data", name: "data"}, {inout: "out", type: "card", name: "mech"} ], tooltip: "Active un mecha", color: "#73BEC8" },
	{ type: "curse", name: "Curse", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "area", name: "player"}, {inout: "out", type: "exe", name: " "} ], tooltip: "Inflige des dégâts de malédiction à un héros", color: "#73BEC8" },
	{ type: "editcurse", name: "Edit Curse", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "area", name: "player"}, {inout: "in", type: "int", name: "damage"}, {inout: "in", type: "int", name: "increment"}, {inout: "out", type: "exe", name: " "} ], tooltip: "Modifie les dégâts de malédiction d'un joueur", color: "#73BEC8" },
	...
	{ type: "setvisibility", name: "Set visibility", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "location", name: "location"}, {inout: "in", type: "visibility", name: "visibility"}, {inout: "out", type: "exe", name: " "} ], tooltip: "Modifie la visibilité d'un emplacement", color: "#73BEC8" },
	{ type: "shuffle", name: "Shuffle", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "area", name: "player"}, {inout: "out", type: "exe", name: " "} ], tooltip: "Mélange le deck d'un joueur", color: "#73BEC8" },
	...
	{ type: "cmpmodels", name: "Compare models", model: [ {inout: "in", type: "model", name: "model 1"}, {inout: "in", type: "model", name: "model 2"}, {inout: "out", type: "bool", name: "same model"} ], tooltip: "Vérifie si deux modèles sont identiques", color: "#89BC62" },
	...
	{ type: "tiletotiles", name: "Location to Locations", model: [ {inout: "in", type: "location", name: "tile"}, {inout: "out", type: "locations", name: "tiles"} ], tooltip: "Transforme un emplacement en zone", color: "#89BC62" },
	...
	{ type: "filtercover", name: "Filter cover", model: [ {inout: "out", type: "cardfilter", name: "global"}, {inout: "out", type: "cardfilter", name: "ground"}, {inout: "out", type: "cardfilter", name: "air"} ], tooltip: "Filtre les entités défendues", color: "#89BC62" },
	...
	{ type: "filterreachable", name: "Filter reachable", model: [ {inout: "in", type: "card", name: "attacker"}, {inout: "out", type: "cardfilter", name: "filter"} ], tooltip: "Filtre les entités à portée d'un personnage", color: "#89BC62" },
	...
	{ type: "filterlr", name: "Filter left-right", model: [ {inout: "in", type: "bool", name: "left"}, {inout: "in", type: "bool", name: "right"},{inout: "out", type: "cardfilter", name: "filter"} ], tooltip: "Filtre des cartes à gauche/droite d'un emplacement", color: "#89BC62" },
	{ type: "filterplaylr", name: "Filter played left-right", model: [ {inout: "in", type: "bool", name: "left"}, {inout: "in", type: "bool", name: "right"},{inout: "out", type: "cardfilter", name: "filter"} ], tooltip: "Filtre des cartes selon si elles ont été jouées à gauche/droite de la main", color: "#89BC62" },
	...
	{ type: "pilot", name: "Pilot", model: [ {inout: "in", type: "card", name: "mech"}, {inout: "out", type: "card", name: "pilot"}, {inout: "out", type: "bool", name: "piloted"} ], tooltip: "Récupère le pilote d'un mecha", color: "#89BC62" },
	{ type: "cursedmg", name: "Curse damage", model: [ {inout: "in", type: "area", name: "player"}, {inout: "out", type: "int", name: "damage"}, {inout: "out", type: "int", name: "increment"} ], tooltip: "Récupère les dégâts de la prochaine malédiction d'un joueur", color: "#89BC62" },
	...
	{ type: "innerdata", name: "Starting card", model: [ {inout: "out", type: "model", name: "card"} ], tooltip: "Modèle de la carte du deck de départ dont l'analyse est en cours", color: "#670e6b" },
	...
	{ type: "analyse", name: "Analyse", model: [ {inout: "in", type: "event", name: "event"}, {inout: "in", type: "period", name: "period"}, {inout: "in", type: "bool", name: "condition"}, {inout: "in", type: "int", name: "value"}, {inout: "out", type: "bool", name: "happened"}, {inout: "out", type: "int", name: "count"} ], tooltip: "Compte le nombre d'événements s'étant produits sur une période donnée", color: "#212121" },
	{ type: "startdeck", name: "Starting deck", model: [ {inout: "in", type: "area", name: "player"}, {inout: "in", type: "bool", name: "condition"}, {inout: "in", type: "int", name: "value"}, {inout: "out", type: "bool", name: "exists"}, {inout: "out", type: "int", name: "count"} ], tooltip: "Compte le nombre de cartes dans le deck de départ", color: "#212121" },
	...
	{ type: "forstart", name: "For each starting card", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "area", name: "player"}, {inout: "in", type: "modelfilter", name: "targets"}, {inout: "out", type: "exe", name: "completed"}, {inout: "out", type: "exe", name: "for each"}, {inout: "out", type: "model", name: "card"} ], tooltip: "Appelle un script pour chaque carte dans le deck de départ", color: "#C0C0C0" },
	...
	{ type: "extraturn", name: "Extra turn", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "area", name: "player"}, {inout: "out", type: "exe", name: " "}, {inout: "out", type: "exe", name: "callback"} ], tooltip: "Accorde un tour supplémentaire à un joueur", color: "#C752A2" },
	{ type: "skipturn", name: "Skip turn", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "area", name: "player"}, {inout: "out", type: "exe", name: " "} ], tooltip: "Passe le restant du tour d'un joueur", color: "#C752A2" },
	...
	{ type: "show", name: "Show", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "model", name: "model"}, {inout: "out", type: "exe", name: " "} ], tooltip: "Montre un modèle de carte aux joueurs", color: "#2196F3" },
