...
const blocks = [
	...
	{ type: "conditionmut", name: "Conditional mutation", model: [ {inout: "in", type: "mutation", name: "mutation"}, {inout: "in", type: "cardfilter", name: "filter"}, {inout: "out", type: "mutation", name: "result"} ], color: "#89BC62" },
