...
const blocks = [
	...
	{ type: "contact", name: "Contact", model: [ {inout: "out", type: "effect", name: " "}, {inout: "out", type: "exe", name: " "}, {inout: "out", type: "card", name: "other"} ], event: [ {inout: "in", type: "data", name: "data"}, {inout: "out", type: "card", name: "attacker"}, {inout: "out", type: "card", name: "defender"} ], tooltip: "Call a script whenever the entity makes contact with another", color: "#871212" },
	...
	{ type: "trap", name: "Auto", model: [ {inout: "out", type: "effect", name: " "}, {inout: "out", type: "exe", name: " "} ], tooltip: "Call a script when drawn", color: "#871212" },
	{ type: "secret", name: "Secret", model: [ {inout: "in", type: "string", name: "text"}, {inout: "in", type: "int", name: "cost"}, {inout: "out", type: "effect", name: " "}, {inout: "out", type: "exe", name: " "}, {inout: "out", type: "data", name: "data"} ], event: [ {inout: "in", type: "data", name: "data"}, {inout: "out", type: "card", name: "secret"} ], tooltip: "Call a script when the secret triggers", color: "#871212" },
	...
	{ type: "movenear", name: "Move Near", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "card", name: "card"}, {inout: "in", type: "location", name: "tile"}, {inout: "out", type: "exe", name: " "}, {inout: "out", type: "location", name: "nearest"} ], tooltip: "Move a card to the nearest empty tile from a given location", color: "#73BEC8" },
	...
	{ type: "discard", name: "Discard", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "card", name: "card"}, {inout: "out", type: "exe", name: " "} ], event: [ {inout: "in", type: "data", name: "data"}, {inout: "out", type: "card", name: "card"} ], tooltip: "Discard a card", color: "#73BEC8" },
	{ type: "cast", name: "Cast", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "card", name: "spell"}, {inout: "in", type: "location", name: "target"}, {inout: "out", type: "exe", name: " "} ], event: [ {inout: "in", type: "data", name: "data"}, {inout: "out", type: "card", name: "spell"}, {inout: "out", type: "card", name: "target"}, {inout: "out", type: "location", name: "target"}, {inout: "out", type: "bool", name: "has target"} ], tooltip: "Cast a spell", color: "#73BEC8" },
	{ type: "counter", name: "Counter", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "card", name: "spell"}, {inout: "out", type: "exe", name: " "} ], tooltip: "Counter a spell", color: "#73BEC8" },
	{ type: "changetarget", name: "Change target", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "card", name: "card"}, {inout: "in", type: "location", name: "target"}, {inout: "out", type: "exe", name: " "} ], tooltip: "Change the target of a card", color: "#73BEC8" },
	...
	{ type: "copy", name: "Copycat", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "card", name: "card"}, {inout: "in", type: "card", name: "model"}, {inout: "out", type: "exe", name: " "} ], tooltip: "Transform into a copy of another card", color: "#73BEC8" },
	...
	{ type: "poison", name: "Poison", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "card", name: "character"}, {inout: "in", type: "int", name: "poison"}, {inout: "out", type: "exe", name: " "} ], event: [ {inout: "in", type: "data", name: "data"}, {inout: "out", type: "card", name: "character"}, {inout: "out", type: "int", name: "poison"} ], tooltip: "Deal poison to a character", color: "#73BEC8" },
	{ type: "curepoison", name: "Cure poison", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "card", name: "character"}, {inout: "in", type: "int", name: "poison"}, {inout: "out", type: "exe", name: " "} ], tooltip: "Remove poison from a character", color: "#73BEC8" },
	...
	{ type: "leveldown", name: "Level down", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "card", name: "hero"}, {inout: "out", type: "exe", name: " "} ], tooltip: "Level down a hero", color: "#73BEC8" },
	...
	{ type: "newcopy", name: "Copy", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "card", name: "model"}, {inout: "in", type: "int", name: "count"}, {inout: "in", type: "location", name: "location"}, {inout: "in", type: "bool", name: "glaze"}, {inout: "out", type: "exe", name: " "}, {inout: "out", type: "card", name: "card"} ], tooltip: "Generate new copies of a card", color: "#73BEC8" },
	...
	{ type: "mutnext", name: "Mutate next card", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "cardfilter", name: "filter"}, {inout: "in", type: "mutation", name: "mutation"}, {inout: "in", type: "area", name: "player"}, {inout: "in", type: "event", name: "end"}, {inout: "out", type: "exe", name: " "} ], tooltip: "Apply a mutation to the next card played", color: "#73BEC8" },
	{ type: "putfl", name: "Put first/last", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "card", name: "card"}, {inout: "in", type: "location", name: "location"}, {inout: "in", type: "bool", name: "first"}, {inout: "in", type: "int", name: "position"}, {inout: "out", type: "exe", name: " "} ], tooltip: "Put a card in first or last position of a location", color: "#73BEC8" },
	{ type: "choosebox", name: "Open choosebox", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "bool", name: "clear"}, {inout: "out", type: "exe", name: " "}, {inout: "out", type: "card", name: "choice"} ], tooltip: "Have the current player choose a card from the choosebox", color: "#73BEC8" },
	...
	{ type: "triggersecret", name: "Trigger secret", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "card", name: "secret"}, {inout: "in", type: "data", name: "data"}, {inout: "out", type: "exe", name: " "} ], tooltip: "Triggers the secret after checking the condition", color: "#73BEC8" },
	{ type: "setvisibility", name: "Set visibility", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "location", name: "location"}, {inout: "in", type: "bool", name: "public"}, {inout: "out", type: "exe", name: " "} ], tooltip: "Set the public visibility of a location", color: "#73BEC8" },
	{ type: "writeintvar", name: "Store integer", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "string", name: "name"}, {inout: "in", type: "int", name: "value"}, {inout: "in", type: "card", name: "src"}, {inout: "out", type: "exe", name: " "} ], tooltip: "Store an integer into a variable", color: "#73BEC8" },
	{ type: "writecardvar", name: "Store card", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "string", name: "name"}, {inout: "in", type: "card", name: "value"}, {inout: "in", type: "card", name: "src"}, {inout: "out", type: "exe", name: " "} ], tooltip: "Store a card into a variable", color: "#73BEC8" },
	{ type: "writemodelvar", name: "Store model", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "string", name: "name"}, {inout: "in", type: "model", name: "value"}, {inout: "in", type: "card", name: "src"}, {inout: "out", type: "exe", name: " "} ], tooltip: "Store a model into a variable", color: "#73BEC8" },
	{ type: "writelocvar", name: "Store location", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "string", name: "name"}, {inout: "in", type: "location", name: "value"}, {inout: "in", type: "card", name: "src"}, {inout: "out", type: "exe", name: " "} ], tooltip: "Store a location into a variable", color: "#73BEC8" },
	{ type: "clearvar", name: "Clear variable", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "string", name: "name"}, {inout: "in", type: "card", name: "src"}, {inout: "out", type: "exe", name: " "} ], tooltip: "Remove a stored variable", color: "#73BEC8" },
	...
	{ type: "canreach", name: "Can reach", model: [ {inout: "in", type: "card", name: "character"}, {inout: "in", type: "card", name: "target"}, {inout: "out", type: "bool", name: "checked"} ], tooltip: "Check if a character can reach another for an attack", color: "#89BC62" },
	...
	{ type: "filtercard", name: "Filter card", model: [ {inout: "in", type: "card", name: "card"}, {inout: "out", type: "cardfilter", name: "same"}, {inout: "out", type: "cardfilter", name: "different"}, {inout: "out", type: "cardfilter", name: "same model"}, {inout: "out", type: "modelfilter", name: "same model"} ], tooltip: "Get a filter focused on a single card", color: "#89BC62" },
	{ type: "filtermodel", name: "Filter model", model: [ {inout: "in", type: "model", name: "model"}, {inout: "out", type: "cardfilter", name: "filter"} ], tooltip: "Filter cards based on their model", color: "#89BC62" },
	{ type: "filterstats", name: "Filter stats", model: [ {inout: "in", type: "int", name: "min cost"}, {inout: "in", type: "int", name: "max cost"}, {inout: "in", type: "int", name: "min atk"}, {inout: "in", type: "int", name: "max atk"}, {inout: "in", type: "int", name: "min hp"}, {inout: "in", type: "int", name: "max hp"}, {inout: "in", type: "int", name: "min range"}, {inout: "in", type: "int", name: "max range"}, {inout: "out", type: "cardfilter", name: "filter"}, {inout: "out", type: "modelfilter", name: "filter"} ], tooltip: "Get a filter using card statistics", color: "#89BC62" },
	{ type: "filtereffect", name: "Filter effect", model: [ {inout: "in", type: "effecttype", name: "type"}, {inout: "out", type: "cardfilter", name: "filter"}, {inout: "out", type: "modelfilter", name: "filter"} ], tooltip: "Get a filter using using card effect types", color: "#89BC62" },
	{ type: "filtervar", name: "Filter variable", model: [ {inout: "in", type: "string", name: "name"}, {inout: "out", type: "cardfilter", name: "filter"} ], tooltip: "Get a filter checking a variable extistence", color: "#89BC62" },
	{ type: "revcfilter", name: "Reverse card filter", model: [ {inout: "in", type: "cardfilter", name: "filter"}, {inout: "out", type: "cardfilter", name: "result"} ], tooltip: "Reverse a card filter output", color: "#89BC62" },
	{ type: "revtfilter", name: "Reverse tile filter", model: [ {inout: "in", type: "tilefilter", name: "filter"}, {inout: "out", type: "tilefilter", name: "result"} ], tooltip: "Reverse a tile filter output", color: "#89BC62" },
	{ type: "revmfilter", name: "Reverse model filter", model: [ {inout: "in", type: "modelfilter", name: "filter"}, {inout: "out", type: "modelfilter", name: "result"} ], tooltip: "Reverse a model filter output", color: "#89BC62" },
	...
	{ type: "mergemfilters", name: "Merge model filters", model: [ {inout: "in", type: "modelfilter", name: "filter 1"}, {inout: "in", type: "modelfilter", name: "filter 2"}, {inout: "out", type: "modelfilter", name: "or"}, {inout: "out", type: "modelfilter", name: "and"} ], tooltip: "Merge model filters into a new element", color: "#89BC62" },
	...
	{ type: "conditiontarget", name: "Conditional target", model: [ {inout: "in", type: "tilefilter", name: "filter"}, {inout: "in", type: "bool", name: "condition"}, {inout: "out", type: "tilefilter", name: "result"} ], tooltip: "Invalid any target if the condition is not fulfilled", color: "#89BC62" },
	{ type: "poisoned", name: "Poisoned", model: [ {inout: "in", type: "card", name: "character"}, {inout: "out", type: "bool", name: "poisoned"}, {inout: "out", type: "int", name: "poison"} ], tooltip: "Check if a character is poisoned", color: "#89BC62" },
	{ type: "hasshield", name: "Has shield", model: [ {inout: "in", type: "card", name: "character"}, {inout: "out", type: "bool", name: "checked"}, {inout: "out", type: "cardfilter", name: "filter"} ], tooltip: "Check if a character has a shield", color: "#89BC62" },
	{ type: "target", name: "Target data", model: [ {inout: "in", type: "card", name: "source"}, {inout: "out", type: "tilefilter", name: "target"}, {inout: "out", type: "bool", name: "has target"} ], tooltip: "Get data about possible targets for a card", color: "#89BC62" },
	...
	{ type: "basestats", name: "Base stats", model: [ {inout: "in", type: "card", name: "card"}, {inout: "out", type: "int", name: "mana"}, {inout: "out", type: "int", name: "atk"}, {inout: "out", type: "int", name: "hp"}, {inout: "out", type: "int", name: "range"}, {inout: "out", type: "int", name: "overload"} ], tooltip: "Get the base stats of a card", color: "#e59c3d" },
	...
	{ type: "brktile", name: "Break tile", model: [ {inout: "in", type: "location", name: "tile"}, {inout: "out", type: "locations", name: "field"}, {inout: "out", type: "area", name: "player"}, {inout: "out", type: "bool", name: "front"}, {inout: "out", type: "bool", name: "empty"}, {inout: "out", type: "card", name: "entity"}, {inout: "out", type: "locations", name: "neighbors"}, {inout: "out", type: "locations", name: "adjacents"}, {inout: "out", type: "locations", name: "ahead"}, {inout: "out", type: "locations", name: "behind"}, {inout: "out", type: "locations", name: "line"}, {inout: "out", type: "location", name: "left"}, {inout: "out", type: "location", name: "right"}, {inout: "out", type: "location", name: "mirror"} ], tooltip: "Get a tile data", color: "#e59c3d" },
	...
	{ type: "intvar", name: "Int variable", model: [ {inout: "in", type: "string", name: "name"}, {inout: "in", type: "card", name: "src"}, {inout: "out", type: "int", name: "value"}, {inout: "out", type: "bool", name: "exists"} ], tooltip: "Get a stored integer", color: "#670e6b" },
	{ type: "cardvar", name: "Card variable", model: [ {inout: "in", type: "string", name: "name"}, {inout: "in", type: "card", name: "src"}, {inout: "out", type: "card", name: "value"}, {inout: "out", type: "bool", name: "exists"} ], tooltip: "Get a stored card", color: "#670e6b" },
	{ type: "modelvar", name: "Model variable", model: [ {inout: "in", type: "string", name: "name"}, {inout: "in", type: "card", name: "src"}, {inout: "out", type: "model", name: "value"}, {inout: "out", type: "bool", name: "exists"} ], tooltip: "Get a stored model", color: "#670e6b" },
	{ type: "locvar", name: "Location variable", model: [ {inout: "in", type: "string", name: "name"}, {inout: "in", type: "card", name: "src"}, {inout: "out", type: "location", name: "value"}, {inout: "out", type: "bool", name: "exists"} ], tooltip: "Get a stored location", color: "#670e6b" },
	...
	{ type: "extremum", name: "Extremum", model: [ {inout: "in", type: "locations", name: "area"}, {inout: "in", type: "cardfilter", name: "filter"}, {inout: "out", type: "card", name: "lowest cost"}, {inout: "out", type: "card", name: "highest cost"}, {inout: "out", type: "card", name: "lowest atk"}, {inout: "out", type: "card", name: "highest atk"}, {inout: "out", type: "card", name: "lowest hp"}, {inout: "out", type: "card", name: "highest hp"} ], tooltip: "Find the card with the most or least of a statistic", color: "#212121" },
	...
	{ type: "findtile", name: "Find random tile", model: [ {inout: "in", type: "locations", name: "area"}, {inout: "in", type: "tilefilter", name: "filter"}, {inout: "out", type: "location", name: "result"}, {inout: "out", type: "bool", name: "found"} ], tooltip: "Find a random tile in an area", color: "#212121" },
	{ type: "findmodel", name: "Find random model", model: [ {inout: "in", type: "modelfilter", name: "filter"}, {inout: "out", type: "model", name: "result"}, {inout: "out", type: "bool", name: "found"} ], tooltip: "Find a random card model", color: "#212121" },
	{ type: "findevent", name: "Find random event", model: [ {inout: "in", type: "event", name: "event"}, {inout: "in", type: "period", name: "period"}, {inout: "in", type: "bool", name: "condition"}, {inout: "out", type: "data", name: "result"}, {inout: "out", type: "bool", name: "found"} ], tooltip: "Find a random event during a period of time", color: "#212121" },
	...
	{ type: "aoe", name: "For each card", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "locations", name: "area"}, {inout: "in", type: "cardfilter", name: "targets"}, {inout: "out", type: "exe", name: "completed"}, {inout: "out", type: "exe", name: "for each"}, {inout: "out", type: "card", name: "card"} ], tooltip: "Call a script for each card in a specific area", color: "#C0C0C0" },
	...
	{ type: "wait", name: "Wait", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "int", name: "ms"}, {inout: "out", type: "exe", name: " "} ], tooltip: "Wait a few time before resuming the effect", color: "#2196F3" },
	{ type: "blink", name: "Blink", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "card", name: "card"}, {inout: "out", type: "exe", name: " "} ], tooltip: "Highlight a card for a listener effect", color: "#2196F3" },
