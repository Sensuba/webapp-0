...
const blocks = [
	...
	{ type: "pilot", name: "Pilot", model: [ {inout: "in", type: "card", name: "mech"}, {inout: "out", type: "card", name: "mech"}, {inout: "out", type: "bool", name: "piloted"} ], tooltip: "Récupère le pilote d'un mecha", color: "#89BC62" },
