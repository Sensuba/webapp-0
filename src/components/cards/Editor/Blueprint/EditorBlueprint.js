...
const blocks = [
	...
	{ type: "trigger", name: "Trigger effect", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "innereffect", name: "effect"}, {inout: "in", type: "location", name: "target"}, {inout: "in", type: "card", name: "source"}, {inout: "out", type: "exe", name: " "} ], tooltip: "Trigger an effect using a source on an optional target", color: "#73BEC8" },
	...
	{ type: "checkeffect", name: "Check effect", model: [ {inout: "in", type: "innereffect", name: "effect"}, {inout: "in", type: "effecttype", name: "type"}, {inout: "out", type: "bool", name: "checked"} ], tooltip: "Check if an effect is a specific type", color: "#89BC62" },
	...
	{ type: "foreffect", name: "For each effect", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "card", name: "card"}, {inout: "in", type: "effecttype", name: "type"}, {inout: "out", type: "exe", name: "completed"}, {inout: "out", type: "exe", name: "for each"}, {inout: "out", type: "innereffect", name: "effect"} ], tooltip: "Call a script for each effect of a card", color: "#C0C0C0" },
