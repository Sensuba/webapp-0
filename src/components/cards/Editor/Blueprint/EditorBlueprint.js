...
const blocks = [
	...
	{ type: "damage", name: "Damage", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "card", name: "entity"}, {inout: "in", type: "card", name: "source"}, {inout: "in", type: "int", name: "damage"}, {inout: "out", type: "exe", name: " "} ], event: [ {inout: "in", type: "data", name: "data"}, {inout: "out", type: "card", name: "entity"}, {inout: "out", type: "card", name: "source"}, {inout: "out", type: "int", name: "damage"} ], tooltip: "Inflige un montant de dégâts à une entité", color: "#73BEC8" },
	...
	{ type: "clearhazards", name: "Clear hazards", model: [ {inout: "in", type: "exe", name: " "}, {inout: "in", type: "location", name: "tile"}, {inout: "out", type: "exe", name: " "} ], tooltip: "Supprime tout événement local d'une case", color: "#73BEC8" },
