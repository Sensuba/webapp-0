...
export default class PortLabelWidget extends BaseWidget<DefaultPortLabelProps, DefaultPortLabelState> {
	...
	render() {
		...
		case "filter": this.props.model.value = this.props.model.value || ""; value = <select onChange={update} className="value"><option></option><option>hero</option><option>figure</option><option>character</option><option>entity</option><option>spell</option><option>artifact</option></select>; break;
		...
		case "timestamp": this.props.model.value = this.props.model.value || "end turn"; value = <select onChange={update} className="value"><option>end turn</option><option>start turn</option></select>; break;
