...
export default class PortLabelWidget extends BaseWidget<DefaultPortLabelProps, DefaultPortLabelState> {
	...
	render() {
		...
		case "hazard": this.props.model.value = this.props.model.value || "fire"; value = <select onChange={update} className="value"><option>fire</option><option>water</option><option>flowers</option><option>butterflies</option><option>wind</option><option>portal</option></select>; break;
		...
		case "location": this.props.model.value = this.props.model.value || "this"; value = <select onChange={update} className="value"><option>this</option><option>hand</option><option>deck</option><option>cemetery</option><option>discard</option><option>opponent's hand</option><option>opponent's deck</option><option>opponent's cemetery</option><option>opponent's discard</option><option>choosebox</option><option>capsule</option></select>; break;
		case "locations": this.props.model.value = this.props.model.value || "board"; value = <select onChange={update} className="value"><option>board</option><option>field</option><option>front</option><option>back</option><option>hand</option><option>deck</option><option>cemetery</option><option>discard</option><option>area</option><option>opponent's field</option><option>opponent's front</option><option>opponent's back</option><option>opponent's hand</option><option>opponent's deck</option><option>opponent's cemetery</option><option>opponent's discard</option><option>opponent's area</option><option>choosebox</option><option>capsule</option><option>everywhere</option></select>; break;
