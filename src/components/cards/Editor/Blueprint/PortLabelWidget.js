...
export default class PortLabelWidget extends BaseWidget<DefaultPortLabelProps, DefaultPortLabelState> {
	...
	render() {
		...
		case "modelfilter": this.props.model.value = this.props.model.value || ""; value = <select onChange={update} className="value"><option></option><option>hero</option><option>figure</option><option>spell</option><option>artifact</option></select>; break;
