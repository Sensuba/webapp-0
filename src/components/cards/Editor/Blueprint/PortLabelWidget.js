...
export default class PortLabelWidget extends BaseWidget<DefaultPortLabelProps, DefaultPortLabelState> {
	...
	render() {
		...
		case "modelfilter": this.props.model.value = this.props.model.value || ""; value = <select onChange={update} className="value"><option></option><option>hero</option><option>figure</option><option>spell</option><option>secret</option><option>artifact</option></select>; break;
		...
		case "period": this.props.model.value = this.props.model.value || "this turn"; value = <select onChange={update} className="value"><option>this turn</option><option>opponent's turn</option><option>since previous turn</option><option>previous turn</option><option>since your turn</option><option>all game</option></select>; break;
