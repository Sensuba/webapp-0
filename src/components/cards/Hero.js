      ...
      <div id={this.props.id} className={"sensuba-card sensuba-hero " + this.props.classColor.color1 + " " + this.props.classColor.color2 + (this.props.switch === "manual" ? " editable" : "")} onClick={this.props.switch === "manual" ? e => this.setState({ level: level%3+1 }) : () => {}}>
	    ...
	    <div className="sensuba-card-body">
	        ...
	        <div className="sensuba-card-body-main">
	        	<div className={"sensuba-card-effect" + (level !== 1 ? " sensuba-card-invisible" : "")} style={{fontSize: (this.props.src.fontSize || 1.3)/2 + 'em'}} dangerouslySetInnerHTML={{__html: this.props.src.htmlDescription}}/>
	        	<div className={"sensuba-card-effect" + (level !== 2 ? " sensuba-card-invisible" : "")} style={{fontSize: (this.props.src.lv2.fontSize || 1.3)/2 + 'em'}} dangerouslySetInnerHTML={{__html: this.props.src.lv2.htmlDescription}}/>
	        	<div className={"sensuba-card-effect" + (level !== 3 ? " sensuba-card-invisible" : "")} style={{fontSize: (this.props.src.lvmax.fontSize || 1.3)/2 + 'em'}} dangerouslySetInnerHTML={{__html: this.props.src.lvmax.htmlDescription}}/>
		...
		<div className="sensuba-card-param sensuba-card-param-atk">
			<div className="sensuba-card-param-name">ATK</div>
		   	<div className={"sensuba-card-param-value" + (level !== 1 ? " sensuba-card-invisible" : "")}>{this.props.src.atk}</div>
		   	<div className={"sensuba-card-param-value" + (level !== 2 ? " sensuba-card-invisible" : "")}>{this.props.src.lv2.atk}</div>
		   	<div className={"sensuba-card-param-value" + (level !== 3 ? " sensuba-card-invisible" : "")}>{this.props.src.lvmax.atk}</div>
		</div>
	    ...
	    { this.props.src.overload && this.props.src.overload > 0 ? <div className={"sensuba-card-overload" + (level !== 1 ? " sensuba-card-invisible" : "")}>{this.props.src.overload}</div> : <span/> }
	    { this.props.src.overload && this.props.src.overload > 0 ? <div className={"sensuba-card-overload" + (level !== 2 ? " sensuba-card-invisible" : "")}>{this.props.src.lv2.overload}</div> : <span/> }
	    { this.props.src.overload && this.props.src.overload > 0 ? <div className={"sensuba-card-overload" + (level !== 3 ? " sensuba-card-invisible" : "")}>{this.props.src.lvmax.overload}</div> : <span/> }
	  </div>
    );
  }
}