...
export default class Spell extends Component {
  ...
  render() {
    ...
    return (
      <div id={this.id}
      className={"sensuba-card sensuba-spell " + this.props.classColor + " " + rarityclass(src.rarity, src.idEdition) + " " + (this.props.holographic ? "sensuba-card-holographic " : " ") + this.props.className}
      onMouseMove={e => {
