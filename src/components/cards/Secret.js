...
export default class Secret extends Component {
  ...
  render() {
    ...
    return (
      <div id={this.props.id} className={"sensuba-card sensuba-secret " + this.props.classColor + " " + rarityclass(src.rarity, src.idEdition) + " " + this.props.className}>
	    ...
	    <span className="sensuba-card-secret-icon">?</span>
