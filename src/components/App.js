      ...
      <div className={"sensuba-app " + (this.state.theme ? this.state.theme + "-theme" : "")}>
        <BrowserRouter>
            <Switch>
              ...
              <Route exact path="/decks/builder" component={({ match, history }) => (<Deckbuilder cards={this.state.cards} customs={this.state.customCards} updateDecks={this.updateDecks.bind(this)} history={history} api={this.props.options.api} type="standard"/>)}/>
