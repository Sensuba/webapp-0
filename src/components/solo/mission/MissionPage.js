    ...
    return (
      <div>
        <Nav api={this.props.api} history={this.props.history}/>
          ...
          <Game api={this.props.api} mission={this.props.mission} training={this.props.training} socket={this.props.socket} updateHeroes={this.changeBackground.bind(this)} quitRoom = {() => this.props.history.push(this.props.mission ? "/solo" : "/play")}/>
      	</main>
      </div>
    );
  }
