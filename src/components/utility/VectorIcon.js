  ...
  render() {
    return (
      <svg viewBox="0 0 52.495 52.495">
        <g>
          <path style="fill:#26B99A;" d="M31.113,16.038V3.99l19.971,20.08l-19.971,20.08V32.102c0,0-17.735-4.292-29.849,16.064
            c0,0-3.02-15.536,10.51-26.794C11.774,21.371,17.903,15.64,31.113,16.038z"/>
          <path style="fill:#26B99A;" d="M0.783,50.929l-0.5-2.573c-0.031-0.161-2.974-16.25,10.852-27.753
