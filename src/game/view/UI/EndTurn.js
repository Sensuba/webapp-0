...
export default class EndTurn extends Component {
  ...
  render () {
    ...
    return (
      <div 	className={"sensuba-end-turn " + (this.props.locked ? "sensuba-end-turn-locked" : "sensuba-end-turn-active")}
      		...
      		<div className="sensuba-end-turn-text">{this.props.locked ? "Opponent's turn" : "End turn"}</div>
      	</div>
    )
  }
}